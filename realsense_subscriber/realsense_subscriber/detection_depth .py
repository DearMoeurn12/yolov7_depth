...
def draw_detections(image, depth, boxes, scores, class_ids, mask_alpha=0.3):
    mask_img = image.copy()
    det_img = image.copy()
...
class MySubscriber(Node):
    def __init__(self, model_path):
        super().__init__('subscriber RGB Depth')
    ...
    def rgb_callback(self, msg):
        ...
        try:
            ...
            boxes, scores, class_ids = self.yolov7_detector(self.cv_image)
    ...
    def depth_callback(self, msg):
        ...
        try:
            ...
            combined_img = self.yolov7_detector.draw_detections(self.cv_image, cv_depth)
